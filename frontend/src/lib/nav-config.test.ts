...
describe("NAV structure — retains every destination (29 at the time this reorg branched, plus Gratuity & Leave, Cashbook, Audit Trail, and File Imports merged in afterward)", () => {
  it("has exactly 33 leaf destinations across direct links and group children", () => {
